    ...
    testimonials: [
      {
        name: 'علی محمدی',
        role: 'والد دانش‌آموز',
        text: 'با تشکر از کادر مجرب مدرسه معراج که با تلاش و پشتکار خود باعث پیشرفت تحصیلی فرزندم شدند.'
      },
      {
        name: 'مریم احمدی',
        role: 'دانش‌آموز',
        text: 'فضای آموزشی مدرسه معراج بسیار عالی است و معلمان دلسوز و با تجربه‌ای دارد.'
      },
      {
        name: 'رضا کریمی',
        role: 'والد دانش‌آموز',
        text: 'برنامه‌ریزی دقیق و مشاوره‌های تحصیلی مدرسه معراج کمک زیادی به آینده تحصیلی فرزندم کرد.'
      }
    ]
  });
