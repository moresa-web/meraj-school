...
interface VibratingFieldErrorProps {
  error: AppError | null;
  duration?: number;
  onDismiss?: () => void;
  className?: string;
...
const VibratingFieldError: React.FC<VibratingFieldErrorProps> = ({
  error,
  duration = 5000,
  onDismiss,
  className = '',
  ...
  }, [error, duration, onDismiss, soundEnabled, vibrationEnabled]);
...
export default VibratingFieldError; 