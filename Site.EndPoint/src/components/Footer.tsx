...
const Footer = () => {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    if (!emailRegex.test(email)) {
      setMessage({ text: t('footer.invalidEmail') || 'ایمیل نامعتبر است', type: 'error' });
      return;
    }
    ...
    try {
      ...
      setMessage({ text: t('footer.subscribeError') || 'خطا در ثبت‌نام خبرنامه', type: 'error' });
    } finally {
      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-section footer-links">
            <h3 className="footer-section-title">
              {t('footer.quickLinks') || 'دسترسی سریع'}
            </h3>
              ...
              <ul className="footer-nav-list">
                ...
                <li>
                  <Link to="/classes" className="footer-nav-link">
                    {t('nav.classes') || 'کلاس‌ها'}
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="footer-nav-link">
                    {t('nav.about') || 'درباره ما'}
                  </Link>
                </li>
                <li>
          ...
          <div className="footer-section footer-contact">
            <h3 className="footer-section-title">
              {t('footer.contactInfo') || 'اطلاعات تماس'}
            </h3>
